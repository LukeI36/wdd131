...
const characters = [
    ...
    },
    {
        ...
        img_name = "bumblebee",
        title1 = "The Bravest Autobot",
        fact1 = "While he may be short in size, ",
        title2 = "",
        fact2 = "",
        title3 = "Voice loss",
        fact3 = "In some adaptations of the Transformers media, Bumblebee is unable to speak, often times because a Decepticon ripped out his voicebox. In order to communicate with his commrades, he uses a radio to mumble up words from channels to make full sentences."
    },
    {
        name = "Starscream",
        alliance = "Decepticon",
